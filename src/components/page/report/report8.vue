<template>
  <div class="base-content base-bg-color">
    <el-row>
      ...
      <el-col :span="10">
        <div class="query_item">
          ...
          <el-button @click="generateReport" type="primary" size="medium">导 出</el-button>
        </div>
      </el-col>
    </el-row>
    ...
    <div style="margin-top:8px;" class="user_info_table base-line">
      <el-table
        :data="siteData"
        style="width: 100%"
        max-height="600"
...
export default {
  ...
  data() {
    return {
      title: "报表8：道路交通声环境监测结果统计表",
      url:"/environment/report/report8",
      pickerOption1: {
        disabledDate(time) {
  ...
  methods: {
    ...
    getData(){
      ...
      this.$axios.post(this.url,{
        ...
        // console.log(res)
        this.loading = false;
        this.siteData = res.data.roadDataSummary;
      })
    },
    export2Excel() {
      ...
      require.ensure([], () => {
        ...
        export_json_to_excel(tHeader, data, "报表8");
      });
    },
