...
export default {
  ...
  data() {
    return {
      title: "报表9：功能区声环境监测结果统计表",
      url: "/environment/report/report9",
      pickerOption1: {
        disabledDate(time) {
    ...
    getData() {
      ...
      this.$axios
        ...
        .then(res => {
          // console.log(res)
          this.loading = false;
          this.siteData = res.data.functionalAreaDataSummary;
        });
    },
    export2Excel() {
      ...
      require.ensure([], () => {
        ...
        export_json_to_excel(tHeader, data, "报表9");
      });
    },
